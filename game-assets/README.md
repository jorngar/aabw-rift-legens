# Rift SEED — Hackathon Asset Pack
...
└── scripts/
    ...
    └── riftAssets.js        # Drop-in pixi.js loader + demo scene
```

## Quick start in pixi.js

1. Copy `game-assets/` into your pixi.js project's public folder (e.g. `public/game-assets/`).
2. Import the loader:

```js
import { loadRiftAssets } from './game-assets/scripts/riftAssets.js';
...
See `scripts/riftAssets.js` for a full isometric demo scene.
