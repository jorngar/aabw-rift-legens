...
const CLASSES = [
  {
    ...
    stats: 'HP: 300 | MP: 60 | DMG: 35 | SPD: 2.8',
  ...
  },
  {
    ...
    stats: 'HP: 180 | MP: 150 | DMG: 20 | SPD: 2.5',
  ...
  },
  {
    ...
    stats: 'HP: 220 | MP: 80 | DMG: 28 | SPD: 4.0',
    passive: 'Backstab: +50% crit from behind',
    skills: ['poisonDagger', 'shadowStrike', 'dash', 'heal'],
  },
  {
    id: 'ranger', name: 'RANGER', color: '#f59e0b',
    desc: 'Ranged attacker with pet companion',
    stats: 'HP: 200 | MP: 100 | DMG: 25 | SPD: 3.2',
