...
Outputs:
  - tools/asset-pipeline/{category}/{name}/frame_001.png, frame_002.png, ...
  - tools/asset-pipeline/atlases/{name}.json   (pixi.js Spritesheet v1 format)

Also writes a master manifest at tools/asset-pipeline/atlases/manifest.json
